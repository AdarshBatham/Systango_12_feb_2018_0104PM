...
${customerlogin}
	<a href="ShowCartController">back</a>
	<%
	...
	<font color="green"><h1>Customer Login</h1>	</font>
							<form action="CustomerLoginControllerWhenCheckOut" method="post">
							<table>
								<tr>
			...
			<%}
				...
				response.sendRedirect("ViewPendingOrderToCustomerWhenCheckOutButLoggedIn");
			%>
