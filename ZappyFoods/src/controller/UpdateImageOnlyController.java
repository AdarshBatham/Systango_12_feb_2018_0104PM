...
/**
 * Servlet implementation class UpdateImageOnlyController
 */
@WebServlet("/UpdateImageOnlyController")
public class UpdateImageOnlyController extends HttpServlet {
     ...
     */
    public UpdateImageOnlyController() {
        super();
...
//			String image=request.getParameter("image");
	...
	try {
	  ...
	  PreparedStatement ps=con.prepareStatement("update product set image=? where id=?");//placeholder
